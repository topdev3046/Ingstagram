"""
Base settings for Ingstagram project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (ingstagram/config/settings/base.py - 3 = ingstagram/)
APPS_DIR = ROOT_DIR.path('ingstagram')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'ingstagram.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Taejun Park""", 'assistcloud11@gmail.com'),
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///ingstagram_db'),
}
...
SOCIALACCOUNT_ADAPTER = 'ingstagram.users.adapters.SocialAccountAdapter'
...
REST_AUTH_REGISTER_SERIALIZERS = {
    'REGISTER_SERIALIZER': 'ingstagram.users.serializers.SignUpSerializer'
}
